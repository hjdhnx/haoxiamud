...
(function(j) {
	...
	function test()
    {go("jh 2;n;n;n;n;n;n;n;n;n;n;n;n;n;n;n;n;n;n;n;n;e;e;e;e;e;e;n;n;n;n;n;n;n;n;n");} 
	function ytl()
	    {go("jh 1;e;kill snow_worker");
	    p=function(){
	    console.log("去比试收破烂的");
	    go("n;n;fight snow_scavenger");
		checkbusy();
	    p=function()
	    {
			console.log("去杀醉汉");
	...
	createButton('找云哥去',btnBox4,test)
	createButton('一条龙',btnBox4,ytl)
	hideButton();
