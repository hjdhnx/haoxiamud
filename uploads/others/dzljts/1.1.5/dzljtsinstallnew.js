...
screenLog.init();
screenLog.log('道长论剑TS正版By劳斯基: version---' + nowversion);
(function(j) {
...
createButton('连环命案'，btnBox4,LHmingan);
function LHmingan(){
	go('jh 1;e;n;n;kill snow_drunk;');
	setTimeout('LHmingan1,3000');
}
function LHmingan1(){
	go('jh 2;n;n;n;n;kill luoyang_luoyang26;');
	setTimeout('LHmingan2,3000');
}
function LHmingan2(){
	go('jh 6;event_1_98623439;ne;ne;fight gaibang_mo-bu;');
	setTimeout('LHmingan3,3000');
}
function LHmingan3(){
	go('jh 1;e;n;n;n;w;buy /map/snow/obj/qiannianlingzhi_N_10 from snow_herbalist;');
	setTimeout('LHmingan3,3000');
}
