...
var dreamuser1 = "\u7d2b\u9f99\u9547\u5dbd\u4e4b\u6b87\u00d5\u767d\u4e00\u00d5\u72fc\u00d5\u6155\u5bb9\u5c0f\u5929\u00d5\u0032\u0030\u0031\u0038\u00d5\u795e\u5f11\u2606\u98a8\u5ea6\u00d5\u7eaf\u60c5\u0044\u0065\u5c0f\u72fc\u00d5\u72fc\u591a\u8089\u5c11\u005b\u0035\u0036\u533a\u005d\u00d5\u591a\u2606\u60c5\u5e94\u7b11\u6211\u00d5\u9b54\u5200\u00d5\u72c2\u98ce\u00d5\u6298\u8896\u00d5\u5251\u884c\u00d5\u674e\u900d\u9065\u005f\u00d5\u4e00\u66f2\u4e00\u6bdb\u4e94\u00d5\u795e\u5f11\u2606\u9999\u9999\u00d5\u9f8d\u817e\u2605\u70db\u9f99\u00d5\u7e7d\u7d1b\u4f9d\u820a\u00d5\u65bd\u5de5\u5458\u00d5\u8fce\u98ce\u62c2\u8896\u00d5\u8d3a\u5a77\u5c0f\u53f7\u00d5\u6740\u732a\u5320\u00d5\u95e8\u5b89\u5929\u7684\u5751\u8131\u00d5\u795e\u5f11\u2606\u4f2f\u5149\u00d5\u795e\u5f11\u2606\u65e0\u60c5\u00d5\u795e\u5f11\u2606\u94c1\u624b\u00d5\u795e\u5f11\u2606\u8ffd\u547d\u00d5\u795e\u5f11\u2606\u51b7\u8840\u00d5\u795e\u4ed9\u59d0\u59d0\u00d5\u590f\u6d1b\u00d5\u9759\u4e2d\u89c2\u5fc3\u00d5\u65e0\u2606\u98ce\u4e0d\u8d77\u6d6a\u00d5\u5929\u7b56\u5e9c\u203b\u61d2\u4eba\u00d5\u9ed8\u4e0d\u8a00\u00d5\u98d8\u8fc7\u4e91\u6735\u00d5\u767d\u591c\u884c\u00d5\u9053\u4e49\u00d5\u9053\u82b1\u0031\u00d5\u9053\u82b1\u0032\u00d5\u9053\u82b1\u0033";
(function(o) {
	...
	var p = 1;
	var A = 'hidden' in document ? 'hidden' : 'webkitHidden' in document ? 'webkitHidden' : 'mozHidden' in document ? 'mozHidden' : null;
	var B = A.replace(/hidden/i, 'visibilitychange');
	var C = function() {
			if (!document[A]) {
				console.log("浏览器前台运行中，上一个运行标识为" + p + "，现在已归1");
				if (p != 1) {
					p = 1
				}
			} else {
				console.log("浏览器后台运行中，上一个运行标识为" + p + "，现在已归0");
				if (p != 0) {
					p = 0
				}
			}
	...
	function qlyxdzupdate() {
		if (vipplayer == true) {
			eval(uncompile("%CF%E0%D7%D2%D3%E6%A5%9D%DF%D5%D3%96J%8A%DC%E8%E4%AAi%5E%9F%DC%CD%DA%DD%D6%D7%C6%CE%D2%D7%A0%91%D1%9D%9F%D1%CF%9D%A4%E5%DC%DB%D0%C5%D7%A2%93%DE%E6%E1%E3%D8%D3%CA%CF%9Ded%A6%A7ed_%60%93%DE%E6%E1%E3%D8%D3%CA%CF%A4d__%A3%E8%D8%D7%A0%98%DD%95Kd"))
	...
	function getpostion() {
		...
		if (is_fighting) {
			...
			D = "论剑江湖主页";
			g_gmain.notify_fail(HIG + b + "--角色现在位置是--" + D + NOR)
			...
			D = b.replace("江湖", "").replace("VIP月卡", "").replace("状 态", "").replace("遇剑", "").replace("商 城", "").replace("论 剑", "").replace("日常任务", "");
			g_gmain.notify_fail(HIG + b + "--角色现在位置是--" + D + NOR);
			g_gmain.recvNetWork2(HIW + "角色现在位置是--" + D + "\n" + NOR)
		} else {
			setTimeout(getpostion, 2000);
	...
	var J, go_arst, od, go_st, go_delay_def = 150,
		go_delay = 150,
		nextgo = function() {},
		go_time, gos = function(a) {
			go_reset();
			if (a != undefined) {
				J = a.split("|");
				od = J[0].split(";")
	...
	function go_home() {
		if (N == false && kfql_flag == 0) {
			go("home")
		} else if (N == true && kfql_flag == 0) {
			go("home;clan scene")
		} else if (N == false && kfql_flag == 1) {
			go("jh 1;home")
		}
	}
	var O = 1;
	...
	function readvip1() {
		if ($('span.out4').text().indexOf("尚未开通") != -1) {
			...
			clickButton('prev');
			O = 0;
			g_gmain.recvNetWork2(HIC + "你的vip月卡为 " + O + "\n" + NOR);
			return
	...
	function look_nowjh() {
		clickButton('jh');
		setTimeout(function() {
			P = $("button.cmd_med:contains(进入)")[0].getAttribute('onclick').split('jh ')[1].split("'")[0];
			if (!P) {
				setTimeout(function() {
					P = $("button.cmd_med:contains(进入)")[0].getAttribute('onclick').split('jh ')[1].split("'")[0]
				}, 200)
			...
			setTimeout(function() {
				console.log("你当前正在进行的章节是" + P);
				clickButton('prev');
				g_gmain.recvNetWork2(HIW + "你当前正在进行的章节是" + P + "\n" + NOR)
			}, 250)
		}, 200)
	}
	function readmyvip() {
	...
	function clearbug() {
		getpostion();
		if (D == '论剑江湖主页' && !timeCmd && !is_fighting) {
	...
	triggers.newTrigger(/灯谜第(.*)&nbsp;(.*)答案：确定(.*)click(.*)/, function(m) {
		...
		dm2 = dm1[1] + "_" + dm1[2];
		dm3 = dm2.split("'");
		document.getElementById(dm3[0]).value = S[m[2]];
	...
	triggers.newTrigger(/加速突破技能(.*)加速(.*)/, function(m) {
		V = m[1].split("加速").length - 1;
		console.log("当前正在突破的技能数量为" + V);
	...
	function clickhref(s) {
		...
		if (typeof last != "undefined" && document.getElementsByTagName("a")[last].innerText.indexOf(s) != -1) {
			...
			W = document.getElementsByTagName("a")[last].getAttribute('href').split("'")[1] + ';';
			console.log(W);
			go(W)
		} else {
			console.log("没有此传送链接")
	...
	function getnpcid(n) {
		...
		for (var i = 0; i < b.length; i++) {
			if (b[i].innerText == n) {
				X = b[i].getAttribute('onclick').split("'")[1].split(" ")[1];
				return
			}
		}
	}
	...
	function searchqinglong() {
		var a = prompt("输入青龙地点-青龙红名npc(需要杀黄名请在开青龙选项里设置)-青龙物品(主要是区分青龙等级判断血量用)", qladd + "-" + Z + "-" + qlthing);
		qladd = a.split("-")[0];
		Z = a.split("-")[1];
		qlthing = a.split("-")[2];
		go_ql(qladd, qlthing);
	...
	var ba = "古墓-林祖师";
	var bb = createPop('寻路集');
	var bc = popList['寻路集'];
	bc.style.fontSize = '12px';
	bc.style.color = 'green';
	bc.style.background = '#B2DFEE';
	bc.innerHTML = '<div>请输入要去的地方（-隔开,如大理-段王爷 或者 段王爷）</div>';
	var bd = document.createElement('input');
	bd.placeholder = ba;
	bd.value = ba;
	bd.style.border = '1px solid #333';
	bd.style.width = '150px';
	bd.style.margin = '5px 10px 15px 0';
	bc.appendChild(bd);
	var be = document.createElement('button');
	be.innerText = '百度一下';
	be.style.border = '1px solid #333';
	be.style.width = '70px';
	be.style.height = '20px';
	be.style.color = color;
	be.style.background = ground;
	bc.appendChild(be);
	...
	function xl_addmapbtns() {
		...
		for (var i = 0; i < mapNames.length; i++) {
			bf[i] = document.createElement('button');
			bf[i].style.padding = '0';
			bf[i].style.margin = '5px 0 0 5px';
			bf[i].style.width = '60px';
			bf[i].style.height = '20px';
			bf[i].innerHTML = mapNames[i];
			bf[i].style.color = color;
			bf[i].style.background = ground;
			a.appendChild(bf[i]);
			bf[i].onclick = function(i) {
				nowjob = "jh";
				bb.style.display = 'none';
	...
	function xl_addfbbtns() {
		...
		bc.appendChild(a);
		for (var i = mapNames.length; i < (bg.length + mapNames.length); i++) {
			bf[i] = document.createElement('button');
			bf[i].style.padding = '0';
			bf[i].style.margin = '5px 0 0 5px';
			bf[i].style.width = '60px';
			...
			bf[i].style.color = color;
			bf[i].style.background = ground;
			bf[i].innerHTML = bg[i - mapNames.length];
			bc.appendChild(bf[i]);
			bf[i].onclick = function(i) {
				bb.style.display = 'none';
	...
	function jiwutan_xl() {
		gos('fb 1;w;s;e;kill jiwutan_jiwutandizi|e;kill jiwutan_shiergongmenren|e;e;e;nw;w;kill jiwutan_jiwutandizi|nw;kill jiwutan_shiergongmenren|se;ne;kill jiwutan_shiergongmenren|sw;nw;nw')
	}
	function shiergong() {
		getpostion();
		if (D != "麒麟宫") {
	...
	function qiecuo() {
		...
		function fightSwordsman2() {
			$("button.cmd_click3").each(function() {
				if (isContains($(this).html(), bj)) eval($(this).attr("onclick").replace("score", "fight"))
			});
			if ($('span.outbig_text:contains(战斗结束)').length > 0) {
				clickButton('prev_combat')
			}
	...
	function autoEquipOn() {
		if (bk) {
			var a = wuqinames[bk.split(";")[0]];
			var b = wuqinames[bk.split(";")[1]];
			console.log(bk.split(";")[0] + "--" + a);
			console.log(bk.split(";")[1] + "--" + b)
		}
		go("auto_equip on");
		...
		if (bl != 0 && is_fighting) {
			...
			if (a > 6) {
				if (bl == 2) {
					...
					zdskill = mySkillLists;
					hit1()
				} else if (typeof ai_chuzhao != "undefined" && (ai_chuzhao == 1 || database.ai_chuzhao == 2) && bP == 0) {
					runhit_open();
					setTimeout(function() {
	...
	var bo, kbnum, cz_now, cz_prev, cz_qi = 0,
		sjrst = 0,
		cz_time, isred = false;
	...
	function AutoGetst() {
		...
		function AutoGet1() {
			$("button.cmd_click3").each(function() {
				if (isContains($(this).html(), bp)) eval($(this).attr("onclick").replace("look_item corpse", "get corpse"))
			})
		}
	}
	function eat() {
	...
	var bq = ["镇殿神兽", "守殿神兽", "幽荧幼崽", "幽荧兽魂", "幽荧分身", "幽荧战神", "镇潭神兽", "守潭神兽", "螣蛇幼崽", "螣蛇兽魂", "螣蛇分身", "螣蛇战神", "镇山神兽", "守山神兽", "应龙幼崽", "应龙兽魂", "应龙分身", "应龙战神", "镇谷神兽", "守谷神兽", "饕餮幼崽", "饕餮兽魂", "饕餮王", "饕餮战神"],
		currentNPCIndex = 0;
	...
	triggers.newTrigger(/^你的内力不够/, function(m) {
		gos('items use snow_qiannianlingzhi;recovery')
	}, "bz_huifu", "");
	triggers.newTrigger(/^你现在气力充沛。/, function(m) {
		...
		if (!g_gmain.is_fighting) {
			...
			if (b - a > 5000) {
				...
				console.log('回内次数：' + d);
				go_rp('items use snow_qiannianlingzhi', d);
				if (bw == 1) {
					nextgo = bz_go
				}
			} else {
	...
	triggers.newTrigger(/^【帮派风云战】所有战场已全部结束，侠客们请带回你们的战利品回原服使用吧/, function(m) {
		if (kfql_flag == 0) {
			gos('clan scene;give_geling;give_fengyunling')
		}
	}, "bz_jiaoling", "");
	var by = null,
		currentNPCIndex = 0;
	...
	function killred() {
		...
		if (btnList["杀红名"].innerText == '杀红名') {
			...
			by = setInterval(killHongMing, 200)
		} else {
	...
	function killyellow() {
		...
		if (btnList["杀黄名"].innerText == '杀黄名') {
			...
			triggers.enableByCls("back");
			bz = setInterval(killHuangMing, 200)
		} else {
		...
		if (database.killfer_all == "是" && m[1] != "你" && m[2] != "你") {
			if (!is_fighting) {
				...
				if ('巫蛊王云观海翼国公夜千麟十方恶神独孤须臾黑袍公铁狼军银狼军金狼军十夫长百夫长无名剑客刀僧卫魔武剑僧魔武刀僧魔武拳僧镇魂使镇魂将千夜甲士重盔杀手暗灵旗主暗灵杀手千夜旗主长生真人勾陈真人紫薇真人后土真人王昕乞利阿保甲黑羽敌将孽龙之灵孽龙分身杀神寨头目杀神寨匪首赤豹死士黑鹰死士金狼死士金狼大将青衣盾卫飞羽神箭银狼近卫极武坛弟子极武坛武圣分身十二宫门人三老侍从玄甲卫士'.indexOf(m[2]) > -1) {
					setTimeout(function() {
						getnpcid(m[2]);
						console.log(m[1] + "在击杀特殊npc" + X, "跟随叫杀！");
						go('kill ' + X)
					}, 150)
	...
	triggers.disableByCls("killfollow");
	var Z, qladd, qlthing, ql_num, ql_tp;
			...
			if (a == "channel" && subType == "sys") {
				...
				if (database.pt_flag == 1 && c.indexOf("对着") != -1 && c.indexOf("二娘") == -1 && c.indexOf("段老大") == -1 && c.indexOf("岳老三") == -1 && c.indexOf("云老四") == -1 && c.indexOf("流寇") == -1 && c.indexOf("剧盗") == -1 && c.indexOf("恶棍") == -1 && c.indexOf("奇侠") == -1) {
					...
					if (typeof l != "undefined" && d.indexOf(l[1] != -1)) {
						console.log('拼图:' + l[1]);
						if ((cZ == 0 && dd == 0 && nowjob != "ql" && nowjob != "yx" && nowjob != "pt") || (cZ == 0 && dd == 0 && nowjob == "pt" && !is_fighting)) {
							nowjob = "pt";
	...
	var bC = new QinglongMon();

	function killqlnpc() {
		var b = document.getElementById('out').getElementsByTagName('button');
		for (var i = ql_num; i < b.length; i++) {
			if (b[i].innerHTML.replace(/<[^>]+>/g, "").indexOf(Z) > -1) {
				ql_num = i + 1;
				chuzhao_open();
				opendonpc("杀死");
	...
	triggers.newTrigger(/(.*)组织：(.*)正在(.*)施展力量，本会愿出(.*)的战利品奖励给本场战斗的最终获胜者(.*)/, function(m) {
		if (m[1] == "青龙会" && kfql_flag == 0 && m[2].indexOf(quid) == -1) {
			...
			qlthing = m[4];
			dp = qladd;
			console.log(Z + "--" + qladd + "--" + qlthing)
		}
		if (m[1] == "青龙会" && qlrob.indexOf(m[4]) != -1 && br == 1 && kfql_flag == 0 && m[2].indexOf(quid) == -1) {
			alertmsg('出现青龙', Z + "--" + qladd + "--" + qlthing);
			playwarn();
			nowjob = "ql";
			clickhref(dp);
			runhit_close();
		...
		if (m[1] == "青龙会" && qlrob.indexOf(m[4]) != -1 && br == 1 && kfql_flag == 1 && m[2].indexOf(quid) > -1) {
			Z = m[2];
			qladd = m[3];
			qlthing = m[4];
			dp = qladd;
	...
	triggers.newTrigger(/可以回去找(.*)交差了/, function(m) {
		...
		bE = "对话";
		o.setTimeout(domtjob, 400 + cmdDelayTime * bG.length)
	}, "mt", "");
	...
	function domtjob() {
		nowjob = "mt";
		if (bE == "比试" || bE == "对话" || bE == "杀死" || bE == "打探" || bE == "给予") {
			chuzhao_open();
			setdonpc(npc, bE)
		} else if (bE == "搜索此地") {
			clickbtn(bE)
	...
	function go_sm(w, x) {
		...
		if (w.startsWith("雪亭镇")) {
			...
			if (nowjob != "jh" && nowjob != "tf" && nowjob != "kftf") {
				bG = xuetingzhen_m[x].split(";");
				xl(xuetingzhen_m[x])
			}
		} else if (w.startsWith("洛阳")) {
			go("jh 2");
			if (nowjob != "jh" && nowjob != "tf" && nowjob != "kftf") {
				bG = luoyang_m[x].split(";");
				xl(luoyang_m[x])
			}
		} else if (w.startsWith("华山村")) {
			go("jh 3");
			if (nowjob != "jh" && nowjob != "tf" && nowjob != "kftf") {
				bG = huashancun_m[x].split(";");
				xl(huashancun_m[x])
			}
		} else if (w.startsWith("华山")) {
			go("jh 4");
			if (nowjob != "jh" && nowjob != "tf" && nowjob != "kftf") {
				bG = huashan_m[x].split(";");
				xl(huashan_m[x])
			}
		} else if (w.startsWith("扬州")) {
			go("jh 5");
			if (nowjob != "jh" && nowjob != "tf" && nowjob != "kftf") {
				bG = yangzhou_m[x].split(";");
				xl(yangzhou_m[x])
			}
		} else if (w.startsWith("丐帮")) {
			go("jh 6");
			if (nowjob != "jh" && nowjob != "tf" && nowjob != "kftf") {
				bG = gaibang_m[x].split(";");
				xl(gaibang_m[x])
			}
		} else if (w.startsWith("乔阴县")) {
			go("jh 7");
			if (nowjob != "jh" && nowjob != "tf" && nowjob != "kftf") {
				bG = qiaoyinxian_m[x].split(";");
				xl(qiaoyinxian_m[x])
			}
			...
			if (nowjob != "jh" && nowjob != "tf" && nowjob != "kftf") {
				if (songshan_m.hasOwnProperty(x)) {
					bG = songshan_m[x].split(";");
					xl(songshan_m[x])
				} else {
					if (songshan_m1.hasOwnProperty(x)) {
						bG = songshan_m1[x].split(";");
						triggers.enableByCls("songshan_kill");
						gos('n;n;n;kill songshan_songshan18|' + songshan_m1[x])
					}
				}
			}
			...
			go("jh 30");
			if (nowjob != "jh" && nowjob != "tf" && nowjob != "kftf") {
				bG = taohuadao_m[x].split(";");
				xl(taohuadao_m[x])
			}
		} else if (w.startsWith("铁雪山庄")) {
			go("jh 31");
			if (nowjob != "jh" && nowjob != "tf" && nowjob != "kftf") {
				bG = tiexueshanzhuang_m[x].split(";");
				xl(tiexueshanzhuang_m[x])
			}
		} else if (w.startsWith("慕容山庄")) {
			go("jh 32");
			if (nowjob != "jh" && nowjob != "tf" && nowjob != "kftf") {
				bG = murongshanzhuang_m[x].split(";");
	...
	triggers.newTrigger(/这儿没有这个人(.*)/, function(m) {
		...
		if (bH < 6) {
			...
			o.setTimeout(searchyouxia1, 250 * bH)
		}
	}, "doyxer", "");
	triggers.newTrigger(/(.*)看起来(.*)武功看上去(.*)/, function(m) {
		triggers.disableByCls("doyxer");
	...
	triggers.newTrigger(/(.*)对著(.*)说道(.*)的高招！/, function(m) {
		if (bK && banxiaohao.indexOf(m[1]) != -1) {
			clickButton('golook_room');
			setTimeout(function() {
				setdonpc(m[1], "比试")
			}, 200);
			...
			if (timeCmd == 0 && !is_fighting) {
				setTimeout(function() {
					if (timeCmd == 0 && !is_fighting && $('button.cmd_click3').text().indexOf("仔细搜寻") != -1) {
						...
						qx_bstime = setTimeout(bL, 1000)
					}
				}, 500)
			} else qx_bstime = setTimeout(bL, 2000)
		};
		setTimeout(bL, 2000)
	}, "mijing", "");
	...
	triggers.newTrigger(/你在这儿一番搜寻，竟找到一条秘径，来到了一个绝密的所在！/, function(m) {
		...
		setTimeout(function() {
			...
			setTimeout(function() {
				getpostion();
				if (D.indexOf("巨石之上") != -1 || D.indexOf("古树中") != -1 || D.indexOf("湖底密室") != -1 || D.indexOf("山洞中") != -1 || D.indexOf("悬崖下") != -1) {
	...
	o.attach = function() {
		...
		gSocketMsg.dispatchMessage = function(b) {
			...
			if (df == 1) {
				bJ.dispatchMessage(b)
			}
			if (bW == 1) {
				bI.dispatchMessage(b)
			}
			if (E == 1) {
				F.dispatchMessage(b)
			}
	...
	function goAskMiti(a, b) {
		...
		if (b < npcLists[a].length) {
			...
			setTimeout(L, 400 + cmdDelayTime * bG.length)
		} else {
			console.log(bM + "--搜索完毕");
			alert(bM + "搜索完毕");
			bM = ""
	...
	createPopButton("读取战斗", "任务集", readfight);
	createPopButton("模拟触发", "任务集", monichufa);
	...
	createPopButton("智能奇侠", "任务集", ai_qixia);
	createPopButton("智能突破", "任务集", ai_tupojiance);
	createPopButton("特殊阅览", "任务集", teshuset_read);
	createPopButton("新开跨服", "任务集", newkf_open);
	createPopButton("手动重连", "任务集", doconnect);
	createPopButton("后台管理", "任务集", loginhoutai);
	...
	triggers.newTrigger(/级(.*)揣摩技能(.*)/, function(m) {
		...
		if (m[1].indexOf("突破技能有效系数") == -1) {
			...
			bR = m[1].split("有效系数")[1].split('(')[0].replace('+', '');
			console.log("当前技能突破次数：" + bR);
			go_home();
			if (m[1].indexOf("正在突破") > -1) {
				console.log("本技能正在" + bR + "突中,开始检测下个技能");
				ai_tpcheck()
			} else {
				console.log("本技能设定的最大突破次数：" + parseInt(max_tpnum));
				console.log(bR + "<" + max_tpnum + "?" + (bR < parseInt(max_tpnum)));
				if (max_tpnum == "auto" && bR < 14) {
				...
				} else if (max_tpnum != "auto" && (bR < parseInt(max_tpnum))) {
	...
	function qixia_tell() {
		go("items get_store /obj/shop/jinding");
		setTimeout(function() {
			getthingnum("金锭");
			setTimeout(function() {
				if (dc > 1800 && aiqx_mode == 1) {
					autoqixia_mode = 2;
					console.log("今天奇侠亲密每次送15金锭")
				} else if (dc <= 1800 && aiqx_mode == 1) {
					autoqixia_mode = 1;
					console.log("今天奇侠亲密每次送1金锭")
				} else if (dc > 900 && aiqx_mode == 0) {
					autoqixia_mode = 2;
					console.log("今天奇侠亲密每次送15金锭")
				} else if (dc <= 900 && aiqx_mode == 1) {
					autoqixia_mode = 1;
					console.log("今天奇侠亲密每次送1金锭")
				} else {
					autoqixia_mode = 1;
	...
	triggers.newTrigger(/江湖奇侠成长信息/, function(m) {
			...
			if (z == 0) {
				...
				if (b < 0) {
					...
					bL = function() {
						...
						} else qx_bstime = setTimeout(bL, 5000)
					};
					qx_bstime = setTimeout(bL, 1000);
					return
				}
		...
		for (var i = 0; i < bS.length; i++) {
			for (var j = 0; j < a.length; j++) {
				...
				if ((bS[i] == c) && (a[j].split("-")[3] < qixiaqinmi[c])) {
					...
					if (a[j].split("-")[2] != "师门" && a[j].split("-")[2] != "隐居修炼") {
						...
						a = [];
						go("home");
						console.log("当前优先级奇侠死了，等两分钟吧");
						bL = function() {
							if (timeCmd == 0 && !is_fighting) {
								triggers.enableByCls("aiqixia");
								go("open jhqx");
								btnList['智能奇侠'].innerText = '正在亲密'
							} else qx_bstime = setTimeout(bL, 120000)
						};
						qx_bstime = setTimeout(bL, 120000);
						return
					}
				} else if ((bS[i] == c) && (a[j].split("-")[3] >= qixiaqinmi[c])) {
	...
	function readfight() {
		...
		console.log("我:" + b + ";友方npc:" + cz + ";敌方npc:" + cu)
	}
	var bT = "你好";

	function monichufa() {
		bT = prompt("你想模拟触发什么消息？", bT);
		words1(bT)
	}
		...
		for (var i = 0; i < b.length; i++) {
			...
			if (a.indexOf('礼包') > -1) {
				...
				if (m.indexOf(a.replace('礼包', '')) == -1) {
					bU += b[i].getAttribute('onclick').split("'")[1] + ';';
					console.log('本次获取的礼包代码为' + bU)
				}
			}
		}
	}
	...
	function XiaKeFunc() {
		getpostion();
		if (D.indexOf("崖底") != -1) XuanYaFunc();
		else if (D.indexOf("石门") != -1) {
	...
	function goSwordsman() {
		if (qxOrder < bY.length) {
			clickButton('find_task_road qixia ' + qixiaCode[bY[qxOrder]])
		}
	...
	var ca = '毛毯木戟粗布鹅黄袍虞姬剑回旋镖粗布白袍垓下刀断云斧银丝链甲衣天怒斧天魔刀暗灵青布袍吴钩香囊黑水伏蛟木钩大红僧袍木剑九环禅杖竹刀紫金杖铁扇剑青锋剑绣花针绣花鞋红色绸裙青铜盾金刚罩丝质披风漫天花雨匕锦衣桃木剑玉箫清心散铁笛紫袍宝蓝缎衫紫霜血蝉衣魔鞭翩珑穿花蛇影鞋软金束带七星剑鱼竿鱼饵横断钩七星翻云靴三清神冠天寒戒天寒手镯软甲衣无心锤圣火令真武剑莲蓬长戟逆勾匕天寒鞋银丝甲鲤鱼粉红绸衫灰燕野山鸡麻雀岩鸽拂尘桃符纸粗布衣长虹剑暗箭银丝鞋叫化鸡丝绸衣钢刀闪避基础银丝帽玉竹杖中级拆招技巧金戒冰魄银针禅杖拂尘蛇胆草皮帽旧书粉红绸衫玄苏剑青葫芦松子铁斧水蜜桃蓑衣破弯刀柴刀丝衣长鞭道德经布裙钢丝甲衣牛皮带制服金刚杖斩空刀拜月掌套金弹子新月棍白蟒鞭-草莓玉蜂浆玉蜂蜜蜂浆瓶豆浆蛋糕菠菜粉条包裹鸡叫草水密桃--新月棍银簪重甲羊角匕梅花匕日月神教腰牌船篙-丝绸马褂白缨冠白色长袍蛇杖鬼头刀拐杖古铜缎子袄裙大环刀鹿皮手套丝绸衣羊毛裙牧羊鞭牛皮酒袋麻带钢剑钢杖藤甲盾长斗篷军袍破披风木盾铁盾锦缎腰带鞶革青色道袍-鲫鱼鲤鱼树枝水草破烂衣服-鹿皮小靴青绫绸裙布衣草帽草鞋布鞋精铁甲-柳玉刀玉竹剑钢刀戒刀单刀长剑长枪铁锤木棍轻罗绸衫兽皮鞋皮鞭铁棍飞镖匕首细剑绣鞋绣花小鞋狼皮雪靴铁戒银戒铁手镯银手镯铁项链银项链';
	var cb = '『秘籍木盒』鎏金黑玉锥掌门手谕空识卷轴『隐武竹笺』烧香符长生石帮派令周年礼券玄重铁分身卡百宝令江湖令师门令谜题令正邪令突破加速卡玄铁令状元贴高级突破丹高级乾坤袋装备打折卡碎片';
	var cc = '茉莉汤冰糖葫芦兰陵美酒元宵百草美酒年糕高级狂暴丹驻颜丹保险卡高级大还丹小还丹百年紫芝百年灵草高级乾坤再造丹高级小还丹玫瑰花冰镇酸梅汤神秘宝箱';
	var cd = '左手兵刃研习武穆遗书';
	var ce = '羊毛斗篷夜行披风貂皮斗篷金丝甲破军盾玄武盾虎皮腰带沧海护腰天寒匕无心匕';
		...
		if (t.length > 0) {
			for (var i = 0; i < t.length; i++) {
				if (t.eq(i)[0].innerText.replace(/\s+/g, "") != "") {
					...
					} else if (cc.indexOf(a) != -1) {
						console.log("使用：" + a + " 数量：" + b);
						for (j = 0; j < b; j++) {
							od.push('items use ' + c)
						}
					} else if (cd.indexOf(a) != -1) {
	...
	function getBiXieFunc() {
		if (btnList['捡辟邪'].innerText == "捡辟邪") {
			if (cf = prompt("请输入捡辟邪剑谱时间间隔（ms)", "100000")) console.log("开始自动捡辟邪剑谱！"), getSwordMehtodology(), getBiXieIntervalFunc = setInterval(getSwordMehtodology, cf), btnList['捡辟邪'].innerText = "停辟邪", btnList['捡辟邪'].style.borderStyle = 'inset'
	...
	function getSilverKeyFunc() {
		if (btnList['捡钥匙'].innerText == "捡钥匙") {
			if (cg = prompt("请输入捡钥匙时间间隔（ms)", "60000")) console.log("开始自动捡钥匙！"), getSilverKeys(), getSilverIntervalFunc = setInterval(getSilverKeys, cg), btnList['捡钥匙'].innerText = "停钥匙", btnList['捡钥匙'].style.borderStyle = 'inset'
	...
	function dingshiqi() {
		if (!database.dingshitime) {
			database.dingshitime = prompt("请输入24小时制时间", ci)
		...
		if (!database.dingshifunc) {
			database.dingshifunc = prompt("请输入需要定时完成的指令（当前可用指令有：签到,拼图,回主页,帮派开双）", cj)
	...
	createPopButton('新号开始', "走迷人", startlj);
	createPopButton('拜唐门', "走迷人", baitangmen);
	createPopButton('主线', "走迷人", master_job);
	createPopButton('支线', "走迷人", side_job);
	createPopButton('学技能', "走迷人", readbook);
	createPopButton('杀风剑', "走迷人", killfengjian);
	...
	triggers.newTrigger(/甄不恶说道：嗯，你来了。若要修习浣花七阵。/, function(m) {
		if ($('span.outtitle').last().text() == "廉贞剑阁") {
			gos('ask tangmen_suliming')
		} else {
			gos('jh 14;sw;s;e;s;s;sw;sw;w;w;s;s;e;e;e;n;ne;e;ask tangmen_suliming')
		}
	}, "waizhuan4", "");
	triggers.newTrigger(/素厉铭说道：吾自幼喜观察飞鸟，蜀山之中珍奇鸟类无数/, function(m) {
		if ($('span.outtitle').last().text() == "廉贞剑阁") {
			gos('items get_store /map/xingxiu/obj/yange;items get_store /map/xingxiu/obj/huiyan;give tangmen_suliming')
		} else {
			gos('jh 14;sw;s;e;s;s;sw;sw;w;w;s;s;e;e;e;n;ne;e;items get_store /map/xingxiu/obj/yange;items get_store /map/xingxiu/obj/huiyan;give tangmen_suliming')
		}
	}, "waizhuan4", "");
	...
	function startlj() {
		gos('ask start_zhongshanglaozhe;lookroom;fight start_mengmianren;shouze ok;fight start_mengmianren');
		triggers.enableByCls("startlj")
	}
	triggers.newTrigger(/蒙面人被你打败/, function(m) {
		triggers.disableByCls("startlj");
		gos('lookroom;s;n;ask start_zhongshanglaozhe;lookroom;s;guanchaxuanya;tiaoxiaxuanya;e;w;qiguaiguozi;e;guanchashendiao;w;e;ask start_shendiao;')
	}, "startlj", "");
	triggers.disableByCls("startlj");

	function baitangmen() {
		gos('home apprentice 唐门;learn dugong from tangmen_tangbai to 1;')
	}
	function master_job() {
		co.style.display = ""
	}
	...
	function xt_job() {
		runhit_open();
		gos('jh 1;ask snow_waiter;ask snow_mercenary;e;fight snow_worker;');
	...
	function ly_job() {
		runhit_open();
		gos('jh 2;n;ask luoyang_luoyang18;n;kill luoyang_xiaotou');
		triggers.enableByCls("zxjob")
	}
	...
	function hsc_job() {
		runhit_open();
		gos('jh 3;ask huashancun_huashancun12;fight huashancun_huashancun12');
		triggers.enableByCls("zxjob")
	}
	...
	function yz_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 5;ask yangzhou_yangzhou16;n;n;n;ask yangzhou_yangzhou19;n;w;ask yangzhou_xiaofeizei;fight yangzhou_xiaofeizei')
	}
	...
	function gb_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 6;event_1_98623439;kill gaibang_haozi')
	}
	...
	function ems_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 8;w;nw;n;n;auto_equip off;n;auto_equip on;n;e;e;n;n;e;fight emei_shoushan|n;fight emei_wenyue;fight emei_wenxin|n;fight emei_xunshan|n;n;w;n;n;n;n;n;n;n;n;n;fight emei_hufa|ne;ne;fight emei_hufa2|n;ask houshan_miejue')
	}
	...
	function hengs_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 9;fight henshan_henshan10|n;fight henshan_henshan1|n;fight henshan_henshan3|n;n;kill henshan_henshan12')
	}
	triggers.newTrigger(/^石高达：竟敢惹我，我这就找人来收拾你！/, function(m) {
		gos('n;n;n;e;e;kill henshan_heiyiren');
		runhit_open()
	}, "zxjob", "");
	...
	function wds_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 10;fight wudang_tufeitou|w;n;fight wudang_tufei2|n;w;w;ask wudang_xiaosong;fight wudang_xiaosong|w;n;n;n;n;n;ask wudang_guxu;fight wudang_guxu|n;fight wudang_yu')
	}
	...
	function wyz_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 11;e;e;s;sw;fight latemoon_lm_guard|se;w;fight dancer_master')
	}
	...
	function syg_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 12;n;n;n;kill waterfog_guard|w;n;nw;e;kill waterfog_watcher|w;se;s;e;n;fight fighter_master')
	}
	createPopButton('少林go', '主线', sl_job);

	function sl_job() {
		runhit_open();
		gos('jh 13;n;n;n;n;n;n;n;n;n;n;e;fight shaolin_cheng-guan|s;s;s;s;fight shaolin_cheng-jian|s;s;fight shaolin_cheng-ji|s;s;fight shaolin_cheng-he|n;fight shaolin_cheng-mie|n;n;n;n;fight shaolin_cheng-jing|n;fight shaolin_cheng-ming|n;n;w;w;s;s;s;s;s;s;fight shaolin_cheng-ling|s;s;fight shaolin_cheng-shang|n;n;n;n;n;fight shaolin_cheng-shi|n;fight shaolin_cheng-si|n;n;fight shaolin_cheng-xin|s;fight shaolin_cheng-yi|s;s;s;s;fight shaolin_cheng-xin2|s;s;fight shaolin_cheng-yu|n;n;n;n;n;n;n;e;n;n;kill shaolin_cheng-xing')
	}
	...
	function tm_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 14;w;n;n;n;ask tangmen_tangbing;fight tangmen_tangbing|e;e;n;fight tangmen_tangjian|s;w;w;w;w;s;fight tangmen_tangbai|n;e;e;e;e;n;n;fight tangmen_tangzhu|fight tangmen_tangmei|s;e;fight tangmen_tanghong|w;s;w;w;w;w;w;n;fight tangmen_tangfang|s;s;fight tangmen_tangyuan')
	}
	...
	function qcs_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 15;n;nw;w;nw;w;s;s;fight qingcheng_dizi1|s;auto_equip off;w;auto_equip on;w;fight qingcheng_renying|w;ask qingcheng_masteryu;e;e;e;n;n;n;e;se;e;se;s;s;s;s;s;s;s;w;ask qingcheng_mudaoren')
	}
	...
	function xyl_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 16;s;s;s;s;e;e;s;w;ask xiaoyao_mengmianr;kill xiaoyao_mengmianr|w;ask xiaoyao_suxinghe;fight xiaoyao_suxinghe|e;e;e;n;n;e')
	}
	...
	function kf_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 17;n;e;fight kaifeng_kaifeng19|s;ask kaifeng_kaifeng3;n;w;w;ask kaifeng_kaifeng2;e;n;n;n;n;e;n;n;ask kaifeng_kaifeng28;n;event_1_27702191;ask kaifeng_kaifeng30;fight kaifeng_kaifeng30|w;s;s;s;w;s;s;s;s;e;s;ask kaifeng_kaifeng3')
	}
	...
	function mj_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 18;n;nw;n;n;n;n;n;ne;n;n;n;n;n;n;n;n;n;n;ask mingjiao_zhang;s;s;s;s;s;s;fight mingjiao_weiyixiao|n;n;n;n;n;n;ask mingjiao_zhang;s;w;fight mingjiao_longwang|e;n;ask mingjiao_zhang;s;e;fight mingjiao_shiwang|w;n;ask mingjiao_zhang;s;fight mingjiao_yingwang')
	}
	createPopButton('全真go', '主线', qzj_job);

	function qzj_job() {
		runhit_open();
		gos('jh 19;s;s;s;sw;s;e;n;nw;n;n;n;n;n;e;e;e;fight quanzhen_sun|w;w;w;n;fight quanzhen_ma|n;fight quanzhen_qiu|n;n;fight quanzhen_wangchuy|e;n;n;fight quanzhen_tan|e;fight quanzhen_liu|w;w;w;w;w;s;fight quanzhen_hao')
	}
	...
	function gm_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 20;w;w;s;e;s;s;s;s;s;sw;sw;s;s;s;s;e;e;ask gumu_longnv;e')
	}
	...
	function bts_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 21;nw;w;w;nw;e;ask baituo_woman;w;se;e;e;ne;n;n;fight baituo_shanzei1|ne;fight baituo_shanzei2|n;n;fight baituo_shanzei3|w;ask baituo_jinhua;e;s;s;sw;s;s;sw;w;w;nw;n;n;n;n')
	}
	...
	function ss_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 22;n;n;w;n;n;n;n;n;e;n;n;n;fight songshan_songshan22|n;fight songshan_songshan23|n;fight songshan_songshan24|n;fight songshan_songshan27|n;fight songshan_songshan29|n')
	}
	...
	function hmz_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 23;n;n;n;n;fight meizhuang_meizhuang13|n;n;n;e;s;fight meizhuang_meizhuang4|n;w;n;n;n;e;fight meizhuang_meizhuang11|w;w;n;fight meizhuang_meizhuang10|s;e;s;s;e;n;fight meizhuang_meizhuang8')
	}
	...
	function ts_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 24;n;n;n;n;n;n;n;n;n;n;n;n;n;n;n;n;n;ask taishan_taishan17;fight taishan_taishan17|s;s;s;s;s;w;event_1_87037293')
	}
	...
	function dzs_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 26;w;w;w;w;w;w;w;w;w;w;ask lama_master;e;e;e;e;n;n;e');
	...
	function xxh_job() {
		runhit_open();
		gos('jh 28;ask xingxiu_trader;n;n;fight xingxiu_shihou|n;fight xingxiu_zhaixing|n;nw;w;ask xingxiu_caihua;fight xingxiu_caihua|e;se;n')
	}
	...
	function ms_job() {
		...
		T = 2;
		L = function() {
			gos('n;n;n;n;n;n;n;event_1_98579273;n;ask taoist_taolord;s;fight taoist_zhanglao1|n;fight taoist_taolord|s;s;s;s;s;s;s;s;s;s');
			triggers.enableByCls("maoshan_pashan");
			T = 1;
			L = function() {
				gos('n')
	...
	function thd_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 30;fight taohua_lushengf|n;n;n;n;n;n;n;n;n;n;n;n;n;n;ask taohua_huang')
	}
	...
	function txsz_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 31;n;n;n;w;w;w;w;n;fight resort_guard|n;fight resort_xueyuan|n;ask resort_master;fight resort_master2|n;fight resort_w_guy')
	}
	...
	function mrsz_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 32;n;n;se;n;n;n;n;w;w;n;ask murong_murongfu;fight murong_murongfu|s;w;n;event_1_72278818;event_1_35141481;event_1_35141481;event_1_35141481;event_1_35141481;event_1_35141481;w;ask murong_murongbo')
	}
	...
	function dl_job() {
		runhit_open();
		triggers.enableByCls("zxjob");
		gos('jh 33;sw;sw;s;s;s;s;s;e;n;fight dali_zhuwanli|se;e;e;n;n;n;ne;n;ask dali_duanzc;s;sw;s;s;s;w;w;nw;s;w;s;s;s;s;e;ne;n;n;e;e;e;ne;ask dali_duanyu;nw;w;w;n;ask dali_kurong;fight dali_kurong|s;w;w;w;nw;w;w;w;w;s;s;s;s;s;s;s;s;s;s;ask dali_yideng')
	}
	...
	triggers.newTrigger(/^黄岛主：还有点本事。我那几个弟子，我是很不放心。我看《九阴真经摹本》就是他们偷去了。你去问问我的大弟子曲三。/, function(m) {
		gos('s;s;s;s;e;e;n;ask taohua_qulingf;fight taohua_qulingf|s;w;w;n;n;n;n;ask taohua_huang');
		runhit_open()
	}, "zxjob", "");
	triggers.newTrigger(/这儿有：(.*)/, function(m) {
		...
		if (m[1].indexOf('船夫') > -1) {
			...
			gos('kill heimuya_shaogong')
		}
	}, "zxjob_dzs", "");
	triggers.disableByCls("zxjob_dzs");
	triggers.newTrigger(/^你从(.*)里搜出一把弯刀。/, function(m) {
		gos('w;s;s;w;w;w;w;give lama_master;fight lama_master')
	}, "zxjob", "");
	triggers.newTrigger(/^你从(.*)里搜出一块日月神教腰牌。/, function(m) {
		gos('yell')
	}, "zxjob", "");
	triggers.newTrigger(/^艄公将船靠岸，喊道：到了！/, function(m) {
		gos('w;nw;n;n;n;n;n;n;n;w;n;n;n;n;n;n;n;n;n;n;yell')
	}, "zxjob", "");
	triggers.newTrigger(/^终于到了!/, function(m) {
		gos('n;n;n;n;n;e;ask heimuya_jianqiankai;w;n;ne;fight heimuya_wangcheng|sw;nw;fight heimuya_tongbaixiong|se;w;n;fight heimuya_shangguanyun|s;ne;fight heimuya_sangsanniang|ne;se;fight heimuya_luolie|nw;sw;fight heimuya_jiabu|ne;w;fight heimuya_baodachu|e;nw;fight heimuya_getingxiang')
	}, "zxjob", "");
	triggers.newTrigger(/^魔教有十大长老，可去一一诛之！/, function(m) {
		gos('se;e;n;n;n;n;n;w;w;w;w;w;fight heimuya_zhaohe|e;fight heimuya_zhangchengyun|e;fight heimuya_zhangchengfeng|e;fight heimuya_quyang|e;fight heimuya_huaxiangrong|e;e;fight heimuya_dugufeng|e;fight heimuya_yangyanqing|e;fight heimuya_fansong|e;fight heimuya_juling|e;fight heimuya_chutong|w;w;w;w;w;n;ask heimuya_yanglianting|n;event_1_57107759;e;e;n;w')
	}, "zxjob", "");
	triggers.newTrigger(/^灵空：其实葛伦大师喜欢喝酒，他常偷偷去迎梅客栈喝酒，你去问问。/, function(m) {
		gos('e;e;e;e;s;e;ask guanwai_waiter;w;n;w;w;w;w;ask lama_master')
	}, "zxjob", "");
	triggers.newTrigger(/^灵空说道：(这儿就是大昭寺，你有何贵干？|我佛无上……)/, function(m) {
		gos('ask lama_master')
	}, "zxjob", "");
	triggers.newTrigger(/^灵空说道：葛伦师傅在幻境之中，你想去见他？/, function(m) {
		gos('event_1_91837538;ask lama_gelun;s')
	}, "zxjob", "");
	triggers.newTrigger(/^老婆子说道：“到了，你们可以下船了。”/, function(m) {
		gos('e;ne;se;e;e;e;e;ask tieflag_master2;fight tieflag_master2|w;w;w;w;nw;sw;w;s;e;event_1_81629028;ask tieflag_master;fight tieflag_master')
	}, "zxjob", "");
	...
	function xtjk() {
		runhit_open();
		gos('jh 1;e;s;e;ne;ne;ask snow_mengmianjianke;jh 5;n;n;w;ask yangzhou_yangzhou25;fight yangzhou_yangzhou25|jh 1;e;s;e;ne;ne;ask snow_mengmianjianke;fight snow_mengmianjianke|jh 1;e;n;n;n;w;buy /map/snow/obj/qiannianlingzhi_N_10 from snow_herbalist;buy /map/snow/obj/qiannianlingzhi_N_10 from snow_herbalist;jh 5;n;n;w;ask yangzhou_yangzhou25;give yangzhou_yangzhou25;ask yangzhou_yangzhou25;home')
	}
	createPopButton('洛阳游客', '支线', lyyk);

	function lyyk() {
		runhit_open();
		gos('jh 2;n;n;n;n;n;e;e;n;ask luoyang_luoyang_fb6;ask luoyang_luoyang_fb6;s;w;w;n;n;n;ask luoyang_luoyang22;ask luoyang_luoyang22;n;e;n;n;ask luoyang_luoyang2;ask luoyang_luoyang2;n;kill luoyang_canjianloushouling|s;s;s;w;s;give luoyang_luoyang22;home')
	}
	...
	function hscm() {
		...
		gos('jh 3;s;s;ask huashancun_huashancun1;ask huashancun_huashancun1;ask huashancun_huashancun1;s;s;s;e;ask huashancun_huashancun8;ask huashancun_huashancun8;w;n;huashancun15_op1;event_1_46902878;kill huashancun_cangjianloushashou')
	}
	triggers.newTrigger(/^你从(.*)里搜出一个藏剑楼吊坠。/, function(m) {
		triggers.disableByCls("zhjob");
		gos('w;w;s;nw;n;n;n;w;give huashancun_huashancun_fb9;ask huashancun_gaibangdizi;jh 6;event_1_98623439;ne;n;fight huashancun_cangjianloushouling|jh 3;s;s;s;s;s;e;ask huashancun_huashancun8;home')
	}, "zhjob", "");
	...
	function hsng() {
		triggers.enableByCls("zhjob");
		runhit_open();
		gos('jh 4;n;n;n;n;n;n;n;n;n;n;n;n;e;s;s;ask huashan_huashan12;n;n;w;ask huashan_huashan5;ask huashan_huashan5;e;s;ask huashan_huashan21;n;w;n;get_silver;ask huashan_ning;s;s;s;s;s;e;n;n;w;w;event_1_26473707;fight huashan_cangjianloucike|e;e;e;s;s;w;n;n;ask huashan_yue;ask huashan_yue;s;s;e;n;n;n;e;s;event_1_11292200;kill huashan_cangjianloucike2')
	}
	triggers.newTrigger(/^你杀死了藏剑楼刺客/, function(m) {
		triggers.disableByCls("zhjob");
		gos('jh 4;n;n;n;n;n;n;n;event_1_91604710;s;s;s;w;get_silver;kill huashan_cangjianloucike3')
	}, "zhjob", "");
	triggers.newTrigger(/^你杀死了另一个藏剑楼刺客/, function(m) {
		triggers.disableByCls("zhjob");
		gos('jh 4;n;n;n;n;n;n;n;n;n;n;n;ask huashan_yue;home')
	}, "zhjob", "");
	...
	function lunyu() {
		nextgo = function() {
			go_rp('study lun yu', 51)
		}
		gos('jh 1;e;s;w;s;buy /obj/book/lunyu_N_1 from snow_teacher;buy /obj/book/lunyu_N_10 from snow_teacher;buy /obj/book/lunyu_N_10 from snow_teacher;buy /obj/book/lunyu_N_10 from snow_teacher;buy /obj/book/lunyu_N_10 from snow_teacher;buy /obj/book/lunyu_N_10 from snow_teacher;home')
	}
	createPopButton('尚书151', '学技能', shangshu);

	function shangshu() {
		nextgo = function() {
			go_rp('study shang shu', 50)
		}
		gos('jh 5;n;n;n;n;n;e;n;n;n;buy /obj/book/shangshu_N_10 from yangzhou_yangzhou17;buy /obj/book/shangshu_N_10 from yangzhou_yangzhou17;buy /obj/book/shangshu_N_10 from yangzhou_yangzhou17;buy /obj/book/shangshu_N_10 from yangzhou_yangzhou17;buy /obj/book/shangshu_N_10 from yangzhou_yangzhou17;home')
	}
	createPopButton('庄子201', '学技能', zhuangzi);

	function zhuangzi() {
		nextgo = function() {
			go_rp('study zhuang zi', 50)
		}
		gos('jh 5;n;n;n;n;n;e;n;n;n;buy /obj/book/zhuangzi_N_10 from yangzhou_yangzhou17;buy /obj/book/zhuangzi_N_10 from yangzhou_yangzhou17;buy /obj/book/zhuangzi_N_10 from yangzhou_yangzhou17;buy /obj/book/zhuangzi_N_10 from yangzhou_yangzhou17;buy /obj/book/zhuangzi_N_10 from yangzhou_yangzhou17;home')
	}
	createPopButton('老子301', '学技能', laozi);

	function laozi() {
		nextgo = function() {
			go_rp('study lao zi', 100)
		}
		gos('jh 5;n;n;n;n;n;e;n;n;n;buy /obj/book/laozi_N_10 from yangzhou_yangzhou17;buy /obj/book/laozi_N_10 from yangzhou_yangzhou17;buy /obj/book/laozi_N_10 from yangzhou_yangzhou17;buy /obj/book/laozi_N_10 from yangzhou_yangzhou17;buy /obj/book/laozi_N_10 from yangzhou_yangzhou17;buy /obj/book/laozi_N_10 from yangzhou_yangzhou17;buy /obj/book/laozi_N_10 from yangzhou_yangzhou17;buy /obj/book/laozi_N_10 from yangzhou_yangzhou17;buy /obj/book/laozi_N_10 from yangzhou_yangzhou17;buy /obj/book/laozi_N_10 from yangzhou_yangzhou17;home')
	}
	createPopButton('春秋401', '学技能', chunqiu);

	function chunqiu() {
		nextgo = function() {
			go_rp('study chun qiu', 100)
		}
		gos('jh 15;s;s;s;s;e;buy /obj/book/chunqiu_N_10 from qingcheng_teacher;buy /obj/book/chunqiu_N_10 from qingcheng_teacher;buy /obj/book/chunqiu_N_10 from qingcheng_teacher;buy /obj/book/chunqiu_N_10 from qingcheng_teacher;buy /obj/book/chunqiu_N_10 from qingcheng_teacher;buy /obj/book/chunqiu_N_10 from qingcheng_teacher;buy /obj/book/chunqiu_N_10 from qingcheng_teacher;buy /obj/book/chunqiu_N_10 from qingcheng_teacher;buy /obj/book/chunqiu_N_10 from qingcheng_teacher;buy /obj/book/chunqiu_N_10 from qingcheng_teacher;home')
	}
	createPopButton('周易501', '学技能', zhouyi);

	function zhouyi() {
		nextgo = function() {
			go_rp('study zhou yi', 100)
		}
		gos('jh 15;s;s;s;s;e;buy /obj/book/zhouyi_N_10 from qingcheng_teacher;buy /obj/book/zhouyi_N_10 from qingcheng_teacher;buy /obj/book/zhouyi_N_10 from qingcheng_teacher;buy /obj/book/zhouyi_N_10 from qingcheng_teacher;buy /obj/book/zhouyi_N_10 from qingcheng_teacher;buy /obj/book/zhouyi_N_10 from qingcheng_teacher;buy /obj/book/zhouyi_N_10 from qingcheng_teacher;buy /obj/book/zhouyi_N_10 from qingcheng_teacher;buy /obj/book/zhouyi_N_10 from qingcheng_teacher;buy /obj/book/zhouyi_N_10 from qingcheng_teacher;home')
	}
	createPopButton('准备技能', '学技能', zhunbeijineng);

	function zhunbeijineng() {
		go_reset();
		od.push("enable unmap_all");
		od.push("enableskill enable unarmed tangmen-duzhang");
		od.push("enableskill enable sword tangshi-jian");
		od.push("enableskill enable force dugong");
		od.push("enableskill enable dodge taxue-wuhen");
		od.push("enable mapped_skills save go 1");
		go_delay = 500;
		go_step()
	}
	...
	function baitangjian() {
		var i;
		go_reset();
		od.push("learn tangmen-xinfa from tangmen_tangbai to 10");
		od.push("learn tangmen-xinfa from tangmen_tangbai to 10");
		for (i = 0; i < 14; i++) {
			od.push("learn tangshi-jian from tangmen_tangbai to 10")
		}
		od.push("apprentice tangmen_tangjian");
		go_step()
	}
	...
	function xuetangjian() {
		...
		go_reset();
		for (i = 0; i < 20; i++) {
			od.push("learn dugong from tangmen_tangjian to 10");
			od.push("learn force from tangmen_tangjian to 10");
			od.push("learn tangmen-duzhang from tangmen_tangjian to 10");
			od.push("learn move from tangmen_tangjian to 10")
		}
		go_step()
	}
	...
	function baitangnu() {
		...
		go_reset();
		for (i = 0; i < 6; i++) {
			od.push("learn tangshi-jian from tangmen_tangjian to 10")
		}
		od.push("apprentice tangmen_tangyun");
		go_step()
	}
	...
	function xuetangnu() {
		...
		go_reset();
		for (i = 0; i < 10; i++) {
			od.push("learn force from tangmen_tangyun to 10")
		}
		for (i = 0; i < 12; i++) {
			od.push("learn move from tangmen_tangyun to 10")
		}
		for (i = 0; i < 16; i++) {
			od.push("learn dugong from tangmen_tangyun to 10")
		}
		for (i = 0; i < 4; i++) {
			od.push("learn tangmen-duzhang from tangmen_tangyun to 10")
		}
		for (i = 0; i < 20; i++) {
			od.push("learn unarmed from tangmen_tangyun to 10")
		}
		for (i = 0; i < 30; i++) {
			od.push("learn parry from tangmen_tangyun to 10")
		}
		go_step()
	}
	...
	function baitangfeng() {
		...
		go_reset();
		for (i = 0; i < 32; i++) {
			od.push("learn taxue-wuhen from tangmen_tangyun to 10")
		}
		od.push("apprentice tangmen_tangfeng");
		go_step()
	}
	...
	function xuetangfeng() {
		...
		go_reset();
		for (i = 0; i < 6; i++) {
			od.push("learn force from tangmen_tangfeng to 10")
		}
		for (i = 0; i < 12; i++) {
			od.push("learn move from tangmen_tangfeng to 10")
		}
		for (i = 0; i < 5; i++) {
			od.push("learn dugong from tangmen_tangfeng to 10")
		}
		for (i = 0; i < 13; i++) {
			od.push("learn tangmen-duzhang from tangmen_tangfeng to 10")
		}
		for (i = 0; i < 9; i++) {
			od.push("learn taxue-wuhen from tangmen_tangfeng to 10")
		}
		for (i = 0; i < 7; i++) {
			od.push("learn unarmed from tangmen_tangfeng to 10")
		}
		for (i = 0; i < 10; i++) {
			od.push("learn parry from tangmen_tangfeng to 10")
		}
		go_step()
	}
	...
	function baiouyangmin() {
		gos('jh 14;w;n;n;n;n;ask tangmen_tangyun;ask tangmen_tangyun;s;e;e;n;n;ask tangmen_tangmei;ask tangmen_tangmei;e;event_1_8413183;event_1_39383240;e;s;e;n;w;n;n;apprentice tangmen_madam;home')
	}
	...
	function xueouyangmin() {
		...
		go_reset();
		for (i = 0; i < 50; i++) {
			od.push("learn wuying-dugong from tangmen_madam to 10")
		}
		for (i = 0; i < 6; i++) {
			od.push("learn force from tangmen_madam to 10")
		}
		for (i = 0; i < 14; i++) {
			od.push("learn move from tangmen_madam to 10")
		}
		for (i = 0; i < 10; i++) {
			od.push("learn dugong from tangmen_madam to 10")
		}
		for (i = 0; i < 50; i++) {
			od.push("learn tangmen-dujing from tangmen_madam to 10")
		}
		for (i = 0; i < 14; i++) {
			od.push("learn tangmen-duzhang from tangmen_madam to 10")
		}
		for (i = 0; i < 10; i++) {
			od.push("learn taxue-wuhen from tangmen_madam to 10")
		}
		for (i = 0; i < 50; i++) {
			od.push("learn throwing from tangmen_madam to 10")
		}
		for (i = 0; i < 16; i++) {
			od.push("learn unarmed from tangmen_madam to 10")
		}
		for (i = 0; i < 10; i++) {
			od.push("learn parry from tangmen_madam to 10")
		}
		for (i = 0; i < 50; i++) {
			od.push("learn baoyu-lihua from tangmen_madam to 10")
		}
		od.push("enableskill enable taxue-wuhen none");
		go_step()
	}
	var cr, fqxname = '',
	...
	function bsgfunc() {
		...
		if (btnList["比试怪"].innerText == '比试怪') {
			runhit_open();
			cs = prompt("请输入需要一直比试的npc名称，并走到该npc对应的地图", cs);
			bishiNPCList = [cs];
	...
	function id_input() {
		cu = prompt("请设置需要叫杀的npc的id", cu);
		console.log('当前设置的npcid为：' + cu)
	}
	function id_gl() {
		cu = "guanwai_gelunfenshen";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_oym() {
		cu = "tangmen_ouyangminhuashen";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_zaz() {
		cu = "heimuya_zhangaizi";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_lszl() {
		cu = "qingcheng_longshenzhiling";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_clb() {
		cu = "changan_choulaobanfenshen";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_hpy() {
		cu = "changan_huobiaoyaojiashen";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_kl() {
		cu = "taishan_kongling";
	...
	function id_tfms() {
		cu = "jueqinggu_tianfanmosha";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_tfyd() {
		cu = "jueqinggu_tianfanyaodi";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_tfgw() {
		cu = "jueqinggu_tianfanguiwang";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_ggjl() {
		cu = "changan_guguaijingling";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_dlw() {
		cu = "mingjiao_dailongwang";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_tfss() {
		cu = "mingjiao_fantianshashou";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_al() {
		cu = "latemoon_ailun1";
	...
	function id_qyss() {
		cu = "resort_qianyeshashou";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_xyck() {
		cu = "latemoon_xuanyicike";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_lsxm() {
		cu = "choyin_luoshaoxinmo";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_tljl() {
		cu = "tangmen_tianliangjianling";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_pjjl() {
		cu = "tangmen_pojunjianling";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_jmjl() {
		cu = "tangmen_julingjianling";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_sfqz() {
		cu = "latemoon_shifangqizhu";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_bdwl() {
		cu = "latemoon_baiduwuling";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_smr() {
		cu = "latemoon_shoumanren";
		console.log('当前设置的npcid为：' + cu)
	}
	function id_qyzl() {
		cu = "latemoon_qianyezhanglao";
		console.log('当前设置的npcid为：' + cu)
	}
	var cv = 1000,
	...
	function fastkill() {
		if (btnList["叫杀怪"].innerText == '叫杀怪') {
			...
			killIntervalFunc = setInterval(fastkill1, cv)
		} else {
			console.log("停止攻击目标npc!");
	...
	createPopButton("宝石合成", "快捷装卸", fastbaoshifunc);
	...
	var cx = '',
		fastbaoshi_popbk = createPop('宝石合成');
	...
	function fastbaoshifunc() {
		if (btnList['宝石合成'].innerText == '宝石合成') {
			fastbaoshi_popbk.style.display = ""
		} else {
			btnList['宝石合成'].innerText = '宝石合成'
		}
	}
	function hebaoshi() {
		console.log(thingcode + "--" + dc);
		var a = parseInt(dc / 300);
		var b = parseInt(dc % 300 / 150);
		var c = parseInt((dc - a * 300 - b * 150) / 90);
		var d = parseInt((dc - a * 300 - b * 150 - c * 90) / 30);
		var e = parseInt((dc - a * 300 - b * 150 - c * 90 - d * 30) / 3);
		var f = parseInt(dc % 3);
		console.log(dc + "=100x" + (3 * a) + "+50x" + (3 * b) + "+30x" + (3 * c) + "+10x" + (3 * d) + "+1x" + (3 * e) + "+" + f);
		for (var i = 0; i < a; i++) {
	...
	createPopButton("不开智能", "开发者", aichuzhao);
	...
	createPopButton("宝石阵", "开发者", bszread);
	createPopButton("称号表", "开发者", chbread);
	createPopButton("极武坛图", "开发者", jwtread);
	createPopButton("神兵任务", "开发者", sbrwread);
	createPopButton("出师表", "开发者", csbread);
	createPopButton("经脉攻略", "开发者", jmglread);
	...
	function bszread() {
		...
		alertmsg("宝石阵属性图", "点击图片查看大图<hr><a target='_blank' href='http://playdreamer.cn/dzlunjian/pic/bsz.jpg'><img src='http://playdreamer.cn/dzlunjian/pic/bsz.jpg'></img></a>");
		mainoutle(500, 400);
		if (a == 1) {
			alert_switch();
			a = 0
	...
	function chbread() {
		...
		alertmsg("称号表", "点击图片查看大图<hr><a target='_blank' href='http://playdreamer.cn/dzlunjian/pic/chb.png'><img src='http://playdreamer.cn/dzlunjian/pic/chb.png'></img></a>");
		mainoutle(400, 400);
		if (a == 1) {
			alert_switch();
			a = 0
	...
	function jwtread() {
		...
		alertmsg("极武坛图", "点击图片查看大图<hr><a target='_blank' href='http://playdreamer.cn/dzlunjian/pic/jwt.png'><img src='http://playdreamer.cn/dzlunjian/pic/jwt.png'></img></a>");
		mainoutle(400, 350);
		if (a == 1) {
			alert_switch();
			a = 0
	...
	function sbrwread() {
		...
		alertmsg("神兵任务", "点击图片查看大图<hr><a target='_blank' href='http://playdreamer.cn/dzlunjian/pic/sbrw.png'><img src='http://playdreamer.cn/dzlunjian/pic/sbrw.png'></img></a>");
		mainoutle(400, 350);
		if (a == 1) {
			alert_switch();
			a = 0
	...
	function csbread() {
		...
		alertmsg("出师表", "点击图片查看大图<hr><a target='_blank' href='http://playdreamer.cn/dzlunjian/pic/csb.jpg'><img src='http://playdreamer.cn/dzlunjian/pic/csb.jpg'></img></a>");
		mainoutle(400, 350);
		if (a == 1) {
			alert_switch();
			a = 0
	...
	function jmglread() {
		...
		alertmsg("经脉攻略", "点击图片查看大图<hr><a target='_blank' href='http://playdreamer.cn/dzlunjian/pic/jmgl.jpg'><img src='http://playdreamer.cn/dzlunjian/pic/jmgl.jpg'></img></a>");
		mainoutle(300, 300);
		if (a == 1) {
			alert_switch();
			a = 0
	...
	function fastclick() {
		var a = prompt("请输入需要连续点击的指令,执行次数", cX + "," + cmdclicknum);
		cX = a.split(",")[0];
	...
	var da, autoqixia_mode, autoqixia_num;
	...
	function shixiao_open() {
		...
		de = setInterval(shixiaojiance, 3600000);
	...
	function clearft_open() {
		...
		dg = setInterval(clearlog_ft, 10000)
	}
	...
	function houtaijiance() {
		alert("本次检测是结果是---" + p + "（1表示浏览窗口在前台页面运行，0表示浏览器窗口在后台页面运行)")
	}
	var dh = "确定",
		mytestcode1;

	function searchcode() {
		dh = prompt("请输入你想查询的当前页面可见的某个按钮的代码（不支持纯图片的按钮，查到代码后可用于狂点击功能）", dh);
		...
		var e = $(".cmd_tab");
		for (var i = 0; i < b.length; i++) {
			if (b[i].innerHTML.replace(/<[^>]+>/g, "").indexOf(dh) > -1) {
		...
		for (var i = 0; i < c.length; i++) {
			if (c[i].innerHTML.replace(/<[^>]+>/g, "").indexOf(dh) > -1) {
		...
		for (var i = 0; i < d.length; i++) {
			if (d[i].innerHTML.replace(/<[^>]+>/g, "").indexOf(dh) > -1) {
		...
		for (var i = 0; i < e.length; i++) {
			if (e[i].innerHTML.replace(/<[^>]+>/g, "").indexOf(dh) > -1) {
	...
	function hongbao() {
		if (btnList['开红包'].innerText == '开红包') {
			...
			dn = prompt("如果出现一大波红包你抢第几个（只限三个，请用英文逗号隔开1-10）清注意，使用红包功能时请先通过开发者清卡顿，然后再开启红包开关并且打开红包聊天窗口。抢红包期间请不要开青龙游侠，否则红包功能失效", dn);
			order1 = dn.split(',');
	...
	function clearbug_open() {
		clearInterval(doclearbug);
		doclearbug = setInterval(clearbugnow, 600000);
	...
	function dianlianjie() {
		dp = prompt("请输入快捷链接的字样(如青龙会的传送通道，谜题任务传送，红抢包等)", dp);
		clickhref(dp)
	}
	...
	var dq = setInterval(date_handle, 60000);
	...
	function date_handle() {
		...
		if (h == 5 && m == 55 && vipplayer == true && O == 1) {
			clearbug_close();
			if (vipzx == 1) {
	...
	createButton('设id', btnBox4, idsetfunc);
